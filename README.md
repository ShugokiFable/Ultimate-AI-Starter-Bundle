# Ultimate AI Starter Bundle v7.9.9.4
...
**v7.9.9.4** — 2026-08-23. Installer hotfix: Register-MCP.ps1 crashed under PowerShell 5.1 when a provider had no prior skyrim-forge registration (stderr redirect under Stop preference). Affects every fresh machine with a claude/grok/codex CLI.
