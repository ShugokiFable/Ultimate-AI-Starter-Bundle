...
- ESP/ESL/ESM and Papyrus
- F4SE native plugins
- CommonLibF4
- xEdit/FO4Edit-compatible records
- BA2 and loose assets

Pin runtime and storefront before F4SE/native work. Do not reuse Skyrim record
or VMAD assumptions.
