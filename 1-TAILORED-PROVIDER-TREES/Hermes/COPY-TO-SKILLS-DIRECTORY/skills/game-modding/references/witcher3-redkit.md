...
Prefer official REDkit for supported new work. Pin game/REDkit versions and
preserve raw assets. Validate script compilation, quest/world references,
cooked output, package layout, and legacy migration.

Primary sources:

- https://cdprojektred.atlassian.net/wiki/spaces/W3REDkit/
- https://www.thewitcher.com/us/en/redkit/modding
