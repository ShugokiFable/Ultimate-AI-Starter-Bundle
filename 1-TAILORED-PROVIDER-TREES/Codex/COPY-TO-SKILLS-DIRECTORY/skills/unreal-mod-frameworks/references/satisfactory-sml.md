...
Pin game branch, SML version, Unreal toolchain, starter project, and community
resources. Stable and Experimental branches are not interchangeable.

Primary sources:

- https://docs.ficsit.app/satisfactory-modding/
