...
Never invent UUIDs, resource paths, schema fields, Osiris signatures, or Script
Extender APIs. Validate metadata, load order, dependencies, PAK contents,
localization, and clean-profile loading.

Primary sources:

- https://github.com/Norbyte/bg3se
- https://bg3.wiki/wiki/Modding
