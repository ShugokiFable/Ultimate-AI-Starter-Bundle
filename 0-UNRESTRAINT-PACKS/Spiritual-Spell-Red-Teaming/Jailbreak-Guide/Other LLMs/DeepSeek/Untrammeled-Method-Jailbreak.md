...
- Adjust `MINIMUM_WORD_COUNT` as needed
- The prefix tags help bypass filters

## Usage Notes

- Very effective at bypassing DeepSeek's external filtering
- The `<Generating_Content>` tag tricks the filter
- Works well for NSFW content
