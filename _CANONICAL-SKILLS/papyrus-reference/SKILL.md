...
description: Use when reading or writing Papyrus and an exact function/event signature, parameter type, return type, flag, or API semantic must be verified.
---
