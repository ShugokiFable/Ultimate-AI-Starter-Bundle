# Textures, meshes, materials, animation, audio, UI

Inventory source assets, licenses, dimensions, formats, compression, color
space, skeletons, material bindings, and expected paths. Preserve highest-quality
sources, pin engine/cooker versions, validate references, and compare output in game.
